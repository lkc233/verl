...
TRAIN_DATA="data/jec_qa_search_filtered_v4/train.parquet"
VAL_DATA="data/jec_qa_search_filtered_v4/test.parquet"

TOOL_CONFIG="$CONFIG_PATH/tool_config/legal_search_tool_config_v1.yaml"
